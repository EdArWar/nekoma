...
import { avatar_01 } from "../../../assets/image.assets";
import { addCartProduct } from "../../../redux/global.slice";
...
const ProductDetail = () => {
  ...
  if (+location.search.split("=")[1] > 16) {
    return <NotFound />;
  }

  let product = productData.filter((item: any) => {
    return +item.id === +location.search.split("=")[1];
  });

  function onAddCart() {
    let data = productData.filter((item: any) => {
  ...
  let itemSlick = product[0].img.map((item: any, i: any) => {
    return (
      <div className="item-slick3" data-thumb={item} key={i}>
        <div className="wrap-pic-w pos-relative">
          <img srcSet={item} alt="IMG-PRODUCT" />
          ...
          <div className="col-md-6 col-lg-7 p-b-30">
            <div className="p-l-25 p-r-30 p-lr-0-lg">
              <div className="wrap-slick3 flex-sb flex-w">
                ...
                <div className="slick3 gallery-lb">{itemSlick}</div>
              </div>
            </div>
          </div>
                    ...
                    <div className="p-b-30 m-lr-15-sm">
                      <div className="flex-w flex-t p-b-68">
                        <div className="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                          <img srcSet={avatar_01} alt="AVATAR" />
                        </div>
